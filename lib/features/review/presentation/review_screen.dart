      ...
      child: Padding(
        ...
        child: LayoutBuilder(
          builder: (BuildContext context, BoxConstraints constraints) {
            ...
            final Widget details = twoColumn
                ? Row(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: <Widget>[
                      Expanded(
                      ...
                      Expanded(
                        child: _RacerDetailCard(
                          title: isSelectionMistake ? '選んでしまった選手' : '回答できなかった枠',
                          accentColor: const Color(0xFFD43D2C),
                          racer: selectedRacer,
                          fallback: mistake.selectedOption,
                          emphasisLabel: isSelectionMistake
                              ? 'YOUR ANSWER'
                              : 'NO ANSWER',
                        ),
                      ),
            ...
            return SingleChildScrollView(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  const SizedBox(height: 12),
                  Text('問題のおさらい', style: theme.textTheme.titleLarge),
                  const SizedBox(height: 8),
                  Text(mistake.prompt, style: theme.textTheme.headlineSmall),
                  if (mistake.promptImageUrl != null &&
                      mistake.promptImageUrl!.isNotEmpty) ...<Widget>[
                    const SizedBox(height: 12),
                    ClipRRect(
...
class _RacerDetailCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final String? labelReading = racer?.nameKana ?? option?.labelReading;
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            if (labelReading != null && labelReading.isNotEmpty) ...<Widget>[
              const SizedBox(height: 4),
              Text(labelReading, style: theme.textTheme.bodyMedium),
            ],
            const SizedBox(height: 12),
            _DetailLine(
              label: '登録番号',
            ...
            _DetailLine(label: '級別', value: racer?.racerClass ?? '---'),
            _DetailLine(label: '性別', value: _genderLabel(racer?.gender)),
            _DetailLine(label: '支部', value: racer?.homeBranch ?? '---'),
            _DetailLine(
              label: '所属',
              value: racer?.affiliationBranch ?? racer?.homeBranch ?? '---',
            ),
          ],
        ),
      ),
